...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -7898.552669010206; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 8435.32538678047; // y position of the second parallel encoder (in tick units)
        public double perpXTicks =  -9448.800604444832; // x position of the perpendicular encoder (in tick units)
    }
